      ...
      <div className="container">
        <div className="info-grid">
          <div className="info-item" data-aos="fade-right">
            <h3>
              <i className="fas fa-map-marker-alt"></i> Encuentranos
            </h3>
            <p>{address}</p>
            <div className="map-buttons">
              <a href={googleMapsUrl} target="_blank" rel="noopener noreferrer" className="btn-map google">
                <i className="fab fa-google"></i> Google Maps
              </a>
              <a href={wazeUrl} target="_blank" rel="noopener noreferrer" className="btn-map waze">
          ...
          <div className="info-item" data-aos="fade-up">
            ...
            <ul className="hours-list">
              <li><span>{info.closed}</span> Cerrado</li>
              <li><span>{info.day1}</span> {info.hours1}</li>
              {info.day2 && <li><span>{info.day2}</span> {info.hours2}</li>}
            </ul>
          </div>

          <div className="info-item" data-aos="fade-left">
            <h3>
              <i className="fas fa-share-alt"></i> Siguenos
            </h3>
