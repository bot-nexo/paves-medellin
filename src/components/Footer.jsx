        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a href={info.instagram} target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram">
                <Instagram size={18} />
              </a>
              <a href={info.facebook} target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Facebook">
                <Facebook size={18} />
              </a>
              {info.tiktok && (
                <a href={info.tiktok} target="_blank" rel="noopener noreferrer" className="footer-social-link footer-social-tiktok" aria-label="TikTok">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li><a href="https://maps.app.goo.gl/jKWVmMneA4KPTjgo6" target="_blank" rel="noopener noreferrer">
